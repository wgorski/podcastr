...
class Track {
  ...
  /// Original YouTube URL — required so a failed download can be retried and
  /// an archived track can be re-downloaded. Legacy rows that predate this
  /// field are migrated to a reconstructed `youtu.be/<id>` in [fromJson].
  ...
  /// URL to share back to the original YouTube video.
  String get shareUrl => sourceUrl;
  ...
  Track copyWith({
    ...
    return Track(
      ...
      subtitlePath: clearSubtitle ? null : (subtitlePath ?? this.subtitlePath),
      subtitleLanguage:
          clearSubtitle ? null : (subtitleLanguage ?? this.subtitleLanguage),
      subtitleIsAutoGenerated: clearSubtitle
          ? false
  ...
  factory Track.fromJson(Map<String, dynamic> j) => Track(
        ...
        sourceUrl: (j['sourceUrl'] as String?) ?? 'https://youtu.be/${j['id']}',
