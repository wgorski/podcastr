...
- **Notifications**: `flutter_local_notifications` for download progress;
  `just_audio_background` for playback
...
lib/
  ...
  services/
    youtube_downloader.dart      # MethodChannel + http stream download
    download_notifier.dart       # status-bar progress notification
  widgets/
